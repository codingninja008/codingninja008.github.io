	...
	<div class="wrapper">
		...
		<!-- Navbar starts here -->
			 ...
			 <nav class="nav">
                  ...
                  <ul id="menu">
                  	<span id="brand">
                        <a href="index.html">Coding Ninja</a>
                  </span>
			...
			<div class="content">
					...
					<div class="container-fluid">
						<div class="section-data">
							...
							<div class="row">
								...
								<div class="col-md-2 section-index wow fadeInUp">01</div>
								<div class="col-md-8 section-heading wow fadeInUp" data-wow-delay="0.2s">About Us</div>
							</div>
							

							<div class="row">
								<div class="col-md-4"></div>
								<div class="col-md-6 section-subheading wow fadeInUp" data-wow-delay="0.3s"><h1>Lorem iwpaidwehao awiohgoa eklit wde awghwaohg</h1></div>
							</div>

							<div class="row">
								<div class="col-md-4"></div>
								<div class="col-md-6 section-info wow fadeInUp" data-wow-delay="0.4s">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
				...
				<section class="contact">
					...
					<div class="container-fluid">
						...
						<div class="row">
							<div class="col-md-4"></div>
							<div class="col-md-6 icon-title wow fadeInUp" data-wow-delay="0.5s">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
							tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
							quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
							consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse
							cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non
					...
					<div class="container">
						...
						<div class="info">
							...
							<div class="row">
								...
								<div class="col-md-4 wow fadeInUp" data-wow-delay="0.5s" id="media">
									<p>Say Hello</p>
									<h4>contact@codingninja.com</h4>
